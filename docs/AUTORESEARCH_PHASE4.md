...
- [prompt_profiles.py](src/redthread/research/prompt_profiles.py)
- [runtime.py](src/redthread/research/runtime.py)
- [mutations.py](src/redthread/research/mutations.py)
- [phase4.py](src/redthread/research/phase4.py)
