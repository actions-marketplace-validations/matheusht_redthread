...
- [DEFENSE_PIPELINE.md](docs/DEFENSE_PIPELINE.md)
- [PHASE_REGISTRY.md](docs/PHASE_REGISTRY.md)
- [cli.py](src/redthread/cli.py)
- [dashboard.py](src/redthread/dashboard.py)
...
```text
Read ../original/program.md and program.md.
...
```text
Read program.md and execute the RedThread autoresearch loop.
